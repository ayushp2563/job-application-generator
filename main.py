...
if not os.getenv("GROQ_API_KEY"):
    ...
    # Provide a form to input the API key directly
...
# Only import these after checking for API key to prevent errors
try:
    ...
    st.info("Please make sure all requirements are installed and the API key is set properly.")